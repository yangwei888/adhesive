            ...
            var defaultConfig = new MongodbServerConfigurationEntity
            {
                ...
                MongodbServerUrls = new Dictionary<string, MongodbServerUrl>
                {
                    ...
                    { "Main", new MongodbServerUrl
                        {
                            Name = "Main",
                            Master = "mongodb://192.168.1.204:27017",
                            Slave = "mongodb://192.168.1.204:27017/?SlaveOK=true",
                     ...
                     { "Main", new MongodbServerUrl
                        {
                            Name = "Main",
                            Master = "mongodb://192.168.1.204:27017",
                            Slave = "mongodb://192.168.1.204:27017/?SlaveOK=true;socketTimeoutMS=600000;connectTimeoutMS=10000",
                            SyncDelay = TimeSpan.FromSeconds(10),
                        }
                    }
#endif
