                                          ...
                                          new  StorageContextConfigurationItem
                                               {
                                                   ...
                                                   ConnectionString = "Server=192.168.1.204;Database=Adhesive;User ID=yangwei;Password=DLdNa9R+IFkkHxvWszyLHw==;Trusted_Connection=False;Persist Security Info=True",
                                               }
                                         }
            };
