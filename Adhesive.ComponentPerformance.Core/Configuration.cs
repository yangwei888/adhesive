    ...
    internal class Configuration
    {
        ...
        internal static ComponentConfigurationEntity GetConfig()
        {
            var defaultConfig = new ComponentConfigurationEntity
            {
                ...
                {
                    {"192_168_1_204_20000", new MongodbConfiguration { Url = "mongodb://192.168.1.204:27017/?slaveok=true", IsMaster = true } },
                    {"192_168_1_209_20000", new MongodbConfiguration { Url = "mongodb://192.168.1.209:27017/?slaveok=true", IsMaster = true } },
                },
                MemcachedList = new Dictionary<string, ComponentConfiguration>
                {
                    {"192_168_1_204_11212", new MemcachedConfiguration { Url = "192.168.1.204:11212" } },
                    {"192_168_1_204_11217", new MemcachedConfiguration { Url = "192.168.1.204:11217" } },
                },
                ...
                {
                    {"192_168_1_209_6379", new RedisConfiguration { Url = "192.168.1.209:6379" } },
                }
#else
